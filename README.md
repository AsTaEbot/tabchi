...
<br>سازنده | creator : 🎇 AsTaE 🎆<a href="https://telegram.me/i_naji"> @AsTae_BOT </a><br>راهنمای استفاده از تبچی‌ بسیار ساده و قابل درک است<br>دیدن مطالب کانال ما و درباره ربات ها  
